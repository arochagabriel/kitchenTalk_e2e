        ...
        stage('Test') {
            ...
            post {
                always {
                    ...
                    publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, escapeUnderscores: false, includes: '*.*,*/*', keepAll: true, reportDir: 'build/courgette-report/', reportFiles: 'index.html', reportName: 'Courgette-JVM Report', reportTitles: ''])
