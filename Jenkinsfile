        ...
        stage('Test') {
            ...
            post {
                always {
                    ...
                    publishHTML([allowMissing: false, alwaysLinkToLastBuild: true, keepAll: true, reportDir: 'build/cucumber-report/cucumber', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
                }
